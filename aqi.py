...
## where to store the ait aquality samples - I use my NAS
#JSON_FILE = '/var/www/html/aqi.json'
JSON_FILE = '/mnt/MyBook2/rpi/airquality/01/aqi.json'
...
if __name__ == "__main__":
    ...
    while True:
        ...
        print("Going to sleep for "+ str(SLEEP_FOR_SECS/60) +" mins...")
        cmd_set_sleep(1)
